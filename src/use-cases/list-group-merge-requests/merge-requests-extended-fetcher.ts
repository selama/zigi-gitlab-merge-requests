...
// const fetchMergeRequestNotes = (project_id: string, iid: string) => {
//     return fetchGitlabResources<NoteDTO>(`/projects/${project_id}/merge_requests/${iid}/notes`);
// }
...
export const fetchExtendedMergeRequests = (mergeRequests: MergeRequestDTO[]) => {
    return Promise.all(mergeRequests.map(async (mergeRequest) => {
        ...
        const [
            ...
            // fetchMergeRequestNotes(project_id, iid),
